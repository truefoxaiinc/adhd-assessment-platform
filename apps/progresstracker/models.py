...
class FaceAttentionSession(models.Model):
    ...
    calculation_version   = models.CharField(max_length=100, default='frontend_attention_v1')
    ...
    maximum_inattention_duration = models.FloatField(default=0.0)
    ...
    reading_engagement_rate = models.FloatField(default=0.0)
    total_processed_frames = models.IntegerField(default=0)
    sampled_frames = models.IntegerField(default=0)
    reading_focused_frames = models.IntegerField(default=0)
    watching_video_frames = models.IntegerField(default=0)
    idle_distracted_frames = models.IntegerField(default=0)
    average_confidence = models.FloatField(default=0.0)
    average_concentration_score = models.FloatField(default=0.0)
    gaze_quality_avg = models.FloatField(default=0.0)
    reading_gaze_frequency_avg_hz = models.FloatField(default=0.0)
    reading_gaze_amplitude_avg = models.FloatField(default=0.0)
...
class UserGoal(models.Model):
    ...
    def __str__(self):
        return f"{self.user.username} - {self.goal[:40]}"
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['user', 'created_at'], name='user_goal_created_idx'),
        ]
